                ...
                <div className='content-down'>
                    {isShowDetailInfor === false&&
                        <div className='short-infor'><FormattedMessage id="patient.extra-infor-doctor.price"/>
                            ...
                            <span className='detail' onClick={()=>this.showHideDetailInfor(isShowDetailInfor)}><FormattedMessage id="patient.extra-infor-doctor.detail"/></span>
                        </div>
                    }
                    {isShowDetailInfor === true &&
                        <>
                            ...
                            <div className='hide-price'><span onClick={()=>this.showHideDetailInfor(isShowDetailInfor)}><FormattedMessage id="patient.extra-infor-doctor.hide-price"/></span></div>
                        </>
                    }
                </div>
            </div>
